...
#extracurriculars(
  activity: "Social Helper, Clinica Koi",
  dates: dates-helper(start-date: "April 2025", end-date: "June 2025"),
 )
- Delivered hands-on robotics and engineering workshops for children and teenagers in vulnerable situations, helping create a safe, engaging space to explore technology.
- Collaborated with a three-person student team to design interactive STEM activities that demonstrated robotics, computer vision, and digital systems concepts in an accessible way.
- Developed the gesture-recognition system for a MediaPipe-based hand gesture painting application, enabling participants to create digital drawings through intuitive motion controls.
- Supported the development of a computer-vision-controlled mobile robot activity, introducing participants to real-time perception, control, and robotics interaction.
