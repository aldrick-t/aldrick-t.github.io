...
#edu(
  degree: "Technical Degree, Mechatronics",
  institution: "CBTis #118 Technical High School",
...
- Designed a soft robotic gripper for strawberry harvesting, including the tool, control software, and circuitry; optimized through iterative 
design to reduce material costs and enhance flexibility. 
...
- Built an AI vision system for in-field strawberry classification, optimized for deployment on both remote servers and edge devices.
