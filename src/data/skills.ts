...
export const skills: SkillDefinition[] = [
  ...
  { id: 'typescript', label: 'TypeScript', group: 'Programming' },
  { id: 'rust', label: 'Rust', group: 'Programming' },
  ...
  { id: 'robotics', label: 'Robotics', group: 'Robotics & autonomy' },
  { id: 'cyber-physical-systems', label: 'Cyber-physical systems', group: 'Robotics & autonomy' },
  ...
  { id: 'smart-interfaces', label: 'Smart interfaces', group: 'Embedded & hardware' },
  { id: 'digital-systems', label: 'Digital systems', group: 'Embedded & hardware' },
  { id: 'circuit-design', label: 'Circuit design', group: 'Embedded & hardware' },
  { id: 'kicad', label: 'KiCad', group: 'Embedded & hardware' },
  { id: 'social-intelligence', label: 'Social intelligence', group: 'Professional & interpersonal' },
  ...
  { id: 'react', label: 'React', group: 'Libraries & frameworks' },
  { id: 'tauri', label: 'Tauri', group: 'Libraries & frameworks' },
